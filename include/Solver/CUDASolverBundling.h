...
public:
	...
	void solve(EntryJ* d_correspondences, unsigned int numberOfCorrespondences,
		...
		bool rebuildJT, bool findMaxResidual, unsigned int revalidateIdx, bool isLocal = true);
...
private:
	...
	void buildVariablesToCorrespondencesTable(EntryJ* d_correspondences, unsigned int numberOfCorrespondences, unsigned int bias = 0);
