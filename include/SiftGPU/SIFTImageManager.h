...
public:
	...
	void RemoveInResidualsCU(unsigned int removeImgIdx, unsigned int removeNum);
	void processResidualsCU(unsigned int leftBias);
	...
	//bool debugIsLocal(){ return false; }
...
//#ifdef TEST_RESIDUAL
	std::vector<int> m_currNumMatches;
//#endif
